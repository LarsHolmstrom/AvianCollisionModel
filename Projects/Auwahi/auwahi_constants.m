...
for i=1:10
    Siemens23_tower(i).lon = Siemens23_lon(i);
    Siemens23_tower(i).lat = Siemens23_lat(i);
end

for i=1:8
    Siemens30_tower(i).lon = Siemens30_lon(i);
    Siemens30_tower(i).lat = Siemens30_lat(i);
end
...
% Assign the tower location for the actual configuration
...
%                               [windfarm_specification.tower_locations([8 1]).y] + 1.5*turbine_specification.turbine_radius];    
%     case 'siemans23' % Siemens SWT 2.3-101
%         bounding_polygon_x = [[windfarm_specification.tower_locations(1:2).x] - 1.5*turbine_specification.turbine_radius ...
%                               [windfarm_specification.tower_locations(10).x] ...
%                               [windfarm_specification.tower_locations(fliplr(3:10)).x] + 1.5*turbine_specification.turbine_radius ...
%                               [windfarm_specification.tower_locations(3).x] ...
%                               [windfarm_specification.tower_locations(1).x] - 1.5*turbine_specification.turbine_radius];
%         bounding_polygon_y = [[windfarm_specification.tower_locations(1).y] + 1.5*turbine_specification.turbine_radius ...
%                               [windfarm_specification.tower_locations([2 10 10]).y] - 1.5*turbine_specification.turbine_radius ...
%                               [windfarm_specification.tower_locations(fliplr(4:9)).y] ...
%                               [windfarm_specification.tower_locations([3 3 1]).y] + 1.5*turbine_specification.turbine_radius];
%                       
%     case 'siemans30' % Siemens SWT 2.3-101
%         bounding_polygon_x = [[windfarm_specification.tower_locations(1:8).x] - 1.5*turbine_specification.turbine_radius ...
%                               [windfarm_specification.tower_locations(8).x] ...
%                               [windfarm_specification.tower_locations(fliplr(1:8)).x] + 1.5*turbine_specification.turbine_radius ...
%                               [windfarm_specification.tower_locations(1).x]];
%         bounding_polygon_y = [[windfarm_specification.tower_locations(1:8).y] ...
%                               [windfarm_specification.tower_locations(8).y] - 1.5*turbine_specification.turbine_radius ...
%                               [windfarm_specification.tower_locations(fliplr(1:8)).y] ...
%                               [windfarm_specification.tower_locations(1).y] + 1.5*turbine_specification.turbine_radius];
%     case 'vestas' % Vestas V90
